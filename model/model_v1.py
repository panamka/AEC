...
class Conformer(nn.Module):
    def __init__(self, stft: StftHandler,  num_layers, inp_dim, out_dim, conformer_kwargs):
        ...
        farend_encoder = [ConformerBlock(**conformer_kwargs) for _ in range(2)]
        ...
        mixture_encoder = [ConformerBlock(**conformer_kwargs) for _ in range(2)]
        ...
        conformer_blocks = [ConformerBlock(**conformer_kwargs) for _ in range(num_layers)]
